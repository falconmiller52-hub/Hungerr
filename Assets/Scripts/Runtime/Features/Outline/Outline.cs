...
public class Outline : MonoBehaviour, IOutline
{
	...
	[SerializeField, Range(0f, 25f)] private float outlineWidth = 2f;
	...
	public void Enable(float width)
	{
		OutlineWidth = width;
	}

	public void Disable(float width)
	{
		OutlineWidth = width;
	}
}