...
namespace Runtime.Features.Location
{
	...
	{
		[Header("Settings")] [SerializeField] private float _fadeInDuration = 0.2f;
		...
		private IEnumerator LocationChangeRoutine(Transform target, bool needCurtain = true,
						bool needToDisableCC = true)
		{
			_isProcessing = true;
